...
subgraph "AWS Infrastructure"
  K8S1 --> |Provision| AWS1[EC2 Instance 1]
  K8S2 --> |Provision| AWS2[EC2 Instance 2]
  K8S3 --> |Provision| AWS3[EC2 Instance 3]
end

subgraph "Terraform"
  AWS1 --> |Terraform| TF1[Terraform Module 1]
  AWS2 --> |Terraform| TF2[Terraform Module 2]
  AWS3 --> |Terraform| TF3[Terraform Module 3]
end
